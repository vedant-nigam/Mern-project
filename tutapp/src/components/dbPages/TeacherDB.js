    ...
    <section className="bg-gray-900">
      <div className="px-6 mx-auto h-screen pt-6">
          ...
          <div className='flex justify-between mt-10'>
            ...
            <a href='/add_teacher' className=' text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-3 py-1 text-center text-lg'>Add</a>
          </div>
          {
            datafound ?
              data.length !== 0 ?
