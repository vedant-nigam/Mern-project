    ...
    <section className="bg-gray-900">
      <div className="px-6 mx-auto h-screen pt-6">
          ...
          <div className='flex justify-between mt-10'>
            <div>
              <a href='/teachers' className=' text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-3 py-1 text-center text-lg mr-4'>Teachers</a>
              <a href='/students' className=' text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-3 py-1 text-center text-lg ml-4'>Students</a>
            </div>
            <a href='/add_student' className=' text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-3 py-1 text-center text-lg'>Add</a>
          </div>
          {
            datafound ?
              data.length !== 0 ?
